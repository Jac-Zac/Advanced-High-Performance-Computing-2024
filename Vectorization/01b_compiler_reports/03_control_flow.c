 ...
 *
 * The "fixed" version isn't semantically identical (finds LAST match, not
 * FIRST), but demonstrates the principle. For exact semantics, you'd need a
 * different approach (maybe SIMD intrinsics with horizontal operations).
 * ============================================================================
 */
