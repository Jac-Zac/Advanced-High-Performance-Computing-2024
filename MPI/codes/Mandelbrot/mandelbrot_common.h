...
static inline void pixel_to_point(double xmin, double xsize, double ymin,
                                  double ysize, double r_width, double r_heigth,
                                  int px, int py, double *cx, double *cy) {
 ...
 */
int compute_perimeter(const Context *ctx, int x, int y, int xsize, int ysize,
                      double *avg_iter);
 ...
 */
void process_patch(Context *ctx, const QueueBackend *backend, Patch *patch);
